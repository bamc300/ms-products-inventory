...
public class ProductClientAdapter implements ProductClientPort {
  ...
  public ProductClientAdapter(RestClient productRestClient,
    ...
    while (attempt <= MAX_RETRIES) {
      try {
        ...
        try {
          ...
          throw new ExternalServiceException("Interrupted during retry", ie);
        }
      } catch (Exception e) {
        throw new ExternalServiceException("Error calling Products Service", e);
      }
    }
    return Optional.empty();
  }
